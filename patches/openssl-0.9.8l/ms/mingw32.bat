...
mingw32-make -f ms/mingw32a.mak all_patched
if errorlevel 1 goto end

echo Generating the DLLs and input libraries
dllwrap --dllname libeay32%DLLSUFFIX%.dll --output-lib out/libeay32.a --def ms/libeay32.def out/libcrypto.a -lwsock32 -lgdi32
if errorlevel 1 goto end
dllwrap --dllname libssl32%DLLSUFFIX%.dll --output-lib out/libssl32.a --def ms/ssleay32.def out/libssl.a out/libeay32.a
if errorlevel 1 goto end
echo Building the *.exe
mingw32-make -f ms/mingw32a.mak exe
